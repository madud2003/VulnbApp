...
import { Zap, Sword, ArrowLeft, ArrowRight } from "lucide-react";
  ...
  const problems = [
    {
      ...
      description: "Explore advanced security attack vectors and defense strategies",
      href: "/learning/level5/problem1",
    ...
    },
    {
      ...
      description: "Learn advanced exploitation methods and countermeasures",
      href: "/learning/level5/problem2",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto">
            Master advanced security concepts and techniques through interactive challenges and real-world scenarios
          </p>
        </motion.div>
                  ...
                  <div className="card p-6 md:p-8 group hover:scale-105 transition-all duration-300">
                    <div className="flex items-center justify-between gap-6">
                      <div className="flex items-center gap-6 flex-1">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <ProblemCompletion level={5} problem={problem.id} />
                          </div>
                      ...
                      <div className="flex-shrink-0">
                        <div className="w-12 h-12 rounded-xl bg-slate-100 border-2 border-slate-200 flex items-center justify-center group-hover:border-pink-500 group-hover:bg-pink-50 transition-all">
                          <ArrowRight className="w-6 h-6 text-slate-600 group-hover:text-pink-600 group-hover:translate-x-1 transition-all" />
                        </div>
                      </div>
                    </div>
                  </div>
