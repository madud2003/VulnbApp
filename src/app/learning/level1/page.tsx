...
import { Lock, Mail, ArrowLeft, ArrowRight, BookOpen } from "lucide-react";
  ...
  const problems = [
    {
      ...
      description: "Learn about password security and brute force attacks",
      href: "/learning/level1/problem1",
    ...
    },
    {
      ...
      description: "Identify and analyze phishing attack vectors",
      href: "/learning/level1/problem2",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto">
            Master the fundamentals of web security through interactive challenges and real-world scenarios
          </p>
        </motion.div>
                  ...
                  <div className="card p-6 md:p-8 group hover:scale-105 transition-all duration-300">
                    <div className="flex items-center justify-between gap-6">
                      <div className="flex items-center gap-6 flex-1">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <ProblemCompletion level={1} problem={problem.id} />
                          </div>
                      ...
                      <div className="flex-shrink-0">
                        <div className="w-12 h-12 rounded-xl bg-slate-100 border-2 border-slate-200 flex items-center justify-center group-hover:border-indigo-500 group-hover:bg-indigo-50 transition-all">
                          <ArrowRight className="w-6 h-6 text-slate-600 group-hover:text-indigo-600 group-hover:translate-x-1 transition-all" />
                        </div>
                      </div>
                    </div>
                  </div>
