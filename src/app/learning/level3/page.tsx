  ...
  const problems = [
    {
      ...
      description: "Explore authentication vulnerabilities and security best practices",
      href: "/learning/level3/problem1",
    ...
    },
    {
      ...
      description: "Learn about session management vulnerabilities",
      href: "/learning/level3/problem2",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto">
            Master authentication mechanisms through interactive challenges and real-world scenarios
          </p>
        </motion.div>
                      ...
                      <div className="flex items-center gap-6 flex-1">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <ProblemCompletion level={3} problem={problem.id} />
                          </div>
